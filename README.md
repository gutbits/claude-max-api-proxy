...
See **[README-WINDOWS.md](README-WINDOWS.md)** for full Windows/VPS instructions.
...
After update you should see `claude-opus-5` first and banner `v1.1.4`. Health: `http://127.0.0.1:3456/health` → `"version":"1.1.4"`.
